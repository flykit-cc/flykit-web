...
export function AgentRow() {
  return (
    // Two across, never four: this row sits in a half-width column, where four
    // cards leave about 120px each and every label truncates to nothing.
      ...
      {AGENTS.map((a) => (
        ...
        >
          ...
          <span className="min-w-0">
            <span className="block font-mono text-sm font-medium">{a.name}</span>
